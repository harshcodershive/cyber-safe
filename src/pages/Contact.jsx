                            ...
                            <div>
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-start p-4 bg-blue-50 rounded-lg">
                                        <svg className="w-6 h-6 text-blue-600 mr-3 mt-1 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                        </svg>
                                        <div>
                                            <div className="text-sm text-slate-500 font-bold uppercase tracking-wider">Email</div>
                                            <a href="mailto:support@cybersafeantivirus.com" className="text-lg font-bold text-slate-900 hover:text-blue-600 transition-colors break-all">support@cybersafeantivirus.com</a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start p-4 bg-blue-50 rounded-lg">
                                        ...
                                        <div>
                                            <div className="text-sm text-slate-500 font-bold uppercase tracking-wider">Office Address</div>
