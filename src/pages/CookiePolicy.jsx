        ...
        <div className="bg-white min-h-screen py-16">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="prose prose-lg text-slate-600 max-w-none">
                    ...
                    <p>
                        Cookies are small text files stored on your device (computer, tablet, or mobile phone) when you visit a website. Cookies help websites function properly, improve user experience, and provide information about how users interact with content.
                    </p>
                    ...
                    <p>
                        Cookies allow us to enhance our content and optimize website performance.
                    </p>

                    <h2 className="text-2xl font-bold text-slate-900 mt-10 mb-6">Types of Cookies We Use</h2>

                    <h3 className="text-xl font-bold text-slate-900 mt-6 mb-4">1. Essential Cookies</h3>
                    <p>
                        These cookies are necessary for the website to function correctly. They enable basic features such as page navigation and access to secure areas of the website.
                    </p>

                    <h3 className="text-xl font-bold text-slate-900 mt-6 mb-4">2. Performance and Analytics Cookies</h3>
                    <p>
                        These cookies help us understand how visitors interact with the website by collecting information such as pages visited, time spent on pages, and traffic sources. This data is used to improve website performance and content quality.
                    </p>

                    <h3 className="text-xl font-bold text-slate-900 mt-6 mb-4">3. Functional Cookies</h3>
                    <p>
                        Functional cookies allow the website to remember user preferences, such as language selection or display settings, to provide a more personalized experience.
                    </p>
