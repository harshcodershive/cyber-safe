                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                            <div className="mb-6">
                                <h3 className="text-2xl font-bold text-slate-900">Harsh Sharma</h3>
                                <p className="text-blue-600 font-medium">Founder</p>
                            </div>
                            <p className="text-slate-600 text-lg leading-relaxed mb-8">
                                Harsh Sharma established cybersafeantivirus with a clear vision: to make digital security accessible to everyone. Based in Jaipur, Rajasthan, Harsh brings a passion for technology and a commitment to user safety. Under his leadership, the platform strives to provide transparent, research-backed advice to help users navigate the complex landscape of cybersecurity.
                            </p>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left border-t border-slate-100 pt-8">
                                <div className="flex items-center space-x-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-slate-400" viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                                        <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                                    </svg>
                                    <span className="text-slate-600">support@cybersafeantivirus.com</span>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-slate-400" viewBox="0 0 20 20" fill="currentColor">
                                        <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                                    </svg>
                                    <span className="text-slate-600">Jaipur, Rajasthan</span>
                                </div>
                                <div className="flex items-center space-x-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-slate-400" viewBox="0 0 20 20" fill="currentColor">
                                        <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                                    </svg>
                                    <span className="text-slate-600">+91 7849976219</span>
                                </div>
                            </div>
                        </div>
                    </div>
